...
CREATE INDEX "customer_stripeCustomerId_idx" ON "customer" USING btree ("stripe_customer_id");--> statement-breakpoint
...
CREATE INDEX "magic_link_email_idx" ON "magic_link" USING btree ("email");--> statement-breakpoint
CREATE INDEX "magic_link_token_idx" ON "magic_link" USING btree ("token");--> statement-breakpoint
