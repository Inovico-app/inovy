...
export class RecordingService {
  ...
  static toDto(recording: Recording): RecordingDto {
    return {
      ...
      transcriptionRetryCount: recording.transcriptionRetryCount,
      transcriptionNextRetryAt: recording.transcriptionNextRetryAt,
      transcriptionLastError: recording.transcriptionLastError,
