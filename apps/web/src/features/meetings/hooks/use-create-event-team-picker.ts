...
async function fetchUserTeams(): Promise<UserTeamsQueryData> {
 ...
 * the create event form (meeting creation with team scoping).
 */
export function useCreateEventTeamPicker() {
