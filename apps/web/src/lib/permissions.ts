...
import type { Action, Resource } from "./access-control";
...
export const Permissions = {
  ...
  department: {
    create: { department: ["create"] } as Permissions,
    read: { department: ["read"] } as Permissions,
    update: { department: ["update"] } as Permissions,
    delete: { department: ["delete"] } as Permissions,
  },
